...
Rectangle {
    ...
    signal requestNavigateToPassPort()

    // 使用 color 类型，并直接绑定到主题颜色
    property color bgColor: (Theme.currentTheme && Theme.currentTheme.colors) ? Theme.currentTheme.colors.backgroundColor : "#F9F9F9"
    property color headerFooterColor: (Theme.currentTheme && Theme.currentTheme.colors) ? Theme.currentTheme.colors.cardColor : "#F9F9F9"
    property color textColor: (Theme.currentTheme && Theme.currentTheme.colors) ? Theme.currentTheme.colors.textSecondaryColor : "#666666"
    property color primaryColor: (Theme.currentTheme && Theme.currentTheme.colors) ? Theme.currentTheme.colors.primaryColor : "#0078D4"
    property color successColor: (Theme.currentTheme && Theme.currentTheme.colors) ? Theme.currentTheme.colors.systemSuccessColor : "#4CAF50"
    property color inactiveColor: (Theme.currentTheme && Theme.currentTheme.colors) ? Theme.currentTheme.colors.controlAltSecondaryColor : "#E0E0E0"
    ...
    Timer {
        ...
        repeat: true
        onTriggered: {
            if (oobeOverlay.isWaitingForLogin && Backend) {
                if (Backend.getBloretPassPortLoginStatus()) {
                    // 登录成功，停止定时器并继续
                    oobeOverlay.isWaitingForLogin = false
                    loginCheckTimer.stop()
                    // 自动进入下一步
                    if (oobeOverlay.currentPage < oobeOverlay.totalPages - 1) {
                        oobeOverlay.currentPage++
                    }
                }
            }
        }
    ...
    Timer {
        ...
        onTriggered: {
            if (Backend) {
                oobeOverlay.minecraftAccounts = Backend.getMinecraftAccounts()
                oobeOverlay.isSyncingAccounts = false
            }
        }
    }
        ...
        RowLayout {
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        anchors.centerIn: parent
                        width: oobeOverlay.currentPage === index ? 32 : 12
                        height: 12
                        radius: 6
                        color: {
                            if (oobeOverlay.currentPage === index) {
                                return primaryColor
                            } else if (index < oobeOverlay.currentPage) {
                                return successColor
                            } else {
                    ...
                    Text {
                        ...
                        font.pixelSize: 11
                        color: textColor
                        visible: oobeOverlay.currentPage === index || index < oobeOverlay.currentPage + 2
                    }
                }
            }
        }
        ...
        Item {
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    visible: oobeOverlay.currentPage === 0
                ...
                Item {
                    Layout.fillWidth: true
                    Layout.fillHeight: true
                    visible: oobeOverlay.currentPage === 1
                ...
                Item {
                    Layout.fillWidth: true
                    Layout.fillHeight: true
                    visible: oobeOverlay.currentPage === 2
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout {
                            Layout.alignment: Qt.AlignHCenter
                            spacing: 12
                            visible: oobeOverlay.isWaitingForLogin
                            ...
                            RowLayout {
                                ...
                                BusyIndicator {
                                    running: oobeOverlay.isWaitingForLogin
                                    implicitWidth: 20
                                    implicitHeight: 20
                                }
                        ...
                        Button {
                            Layout.alignment: Qt.AlignHCenter
                            text: {
                                if (oobeOverlay.isWaitingForLogin) {
                            ...
                            highlighted: !oobeOverlay.isWaitingForLogin
                            onClicked: {
                                if (Backend && Backend.getBloretPassPortLoginStatus()) {
                                    ...
                                    oobeOverlay.isWaitingForLogin = true
                ...
                Item {
                    Layout.fillWidth: true
                    Layout.fillHeight: true
                    visible: oobeOverlay.currentPage === 3
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                Layout.alignment: Qt.AlignHCenter
                                spacing: 8
                                visible: oobeOverlay.isSyncingAccounts

                                BusyIndicator {
                                    running: oobeOverlay.isSyncingAccounts
                                    implicitWidth: 20
                                    implicitHeight: 20
                                }
                            ...
                            ColumnLayout {
                                Layout.alignment: Qt.AlignHCenter
                                spacing: 8
                                visible: !oobeOverlay.isSyncingAccounts && oobeOverlay.minecraftAccounts.length > 0
                                ...
                                Repeater {
                                    model: oobeOverlay.minecraftAccounts

                                    Rectangle {
                                        width: 400
                                        height: 50
                                        radius: 8
                                        color: Theme.currentTheme && Theme.currentTheme.colors ? Theme.currentTheme.colors.cardColor : "#FFFFFF"
                                        border.width: 1
                                        border.color: Theme.currentTheme && Theme.currentTheme.colors ? Theme.currentTheme.colors.controlAltSecondaryColor : "#E0E0E0"
                                        ...
                                        RowLayout {
                                            ...
                                            Rectangle {
                                                ...
                                                radius: 16  // 圆形
                                                clip: true
                                                color: Theme.currentTheme && Theme.currentTheme.colors ? Theme.currentTheme.colors.controlAltSecondaryColor : "#E0E0E0"
                                                ...
                                                Image {
                                                    ...
                                                    Text {
                                                        ...
                                                        font.bold: true
                                                        color: primaryColor
                                                        visible: avatarImage.status === Image.Loading || avatarImage.status === Image.Error || avatarImage.source === ""
                                                    }
                                                }
                                            }
                                            ...
                                            Rectangle {
                                                ...
                                                width: defaultLabel.implicitWidth + 12
                                                height: 20
                                                radius: 10
                                                color: primaryColor
                        ...
                        Button {
                            Layout.alignment: Qt.AlignHCenter
                            text: {
                                if (oobeOverlay.isSyncingAccounts) {
                                    return Backend ? Backend.tr("同步中...") : "Syncing..."
                                } else if (oobeOverlay.minecraftAccounts.length > 0) {
                                    return Backend.tr("重新同步")
                                }
                                return Backend ? Backend.tr("同步账户") : "Sync Account"
                            }
                            highlighted: true
                            enabled: !oobeOverlay.isSyncingAccounts
                            onClicked: {
                                if (Backend) {
                                    oobeOverlay.isSyncingAccounts = true
                ...
                Item {
                    Layout.fillWidth: true
                    Layout.fillHeight: true
                    visible: oobeOverlay.currentPage === 4
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Button {
                                ...
                                enabled: !oobeOverlay.isCheckingJava && !oobeOverlay.isInstallingJava
                                onClicked: {
                                    if (Backend) {
                                        oobeOverlay.isCheckingJava = true
                                        Backend.checkJavaEnvironment()
                                    }
                                }
                            }
                            ...
                            Button {
                                text: {
                                    if (oobeOverlay.isInstallingJava) {
                                        return Backend ? Backend.tr("正在安装...") : "Installing..."
                                    }
                                    return Backend ? Backend.tr("安装 Java 21") : "Install Java 21"
                                }
                                highlighted: !oobeOverlay.javaInstalled
                                enabled: !oobeOverlay.isCheckingJava && !oobeOverlay.isInstallingJava
                                onClicked: {
                                    if (Backend) {
                                        oobeOverlay.isInstallingJava = true
                ...
                Item {
                    Layout.fillWidth: true
                    Layout.fillHeight: true
                    visible: oobeOverlay.currentPage === 5
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            TextField {
                                id: minecraftDirEdit
                                text: oobeOverlay.minecraftDirPath
                                ...
                                onClicked: {
                                    if (Backend) {
                                        ...
                                        if (selectedDir && selectedDir !== "") {
                                            oobeOverlay.minecraftDirPath = selectedDir
                                        }
                                    }
                                }
                            }
    ...
    function canProceed() {
        switch (oobeOverlay.currentPage) {
            case 0: return true
            case 1: return true
    ...
    function finishOOBE() {
        if (Backend) {
            Backend.setMinecraftDirectory(oobeOverlay.minecraftDirPath)
    ...
    Connections {
        ...
        function onCurrentThemeChanged() {
            // 主题变化时，属性会自动更新，因为它们是绑定到 Theme.currentTheme.colors 的
        }
    }
}
